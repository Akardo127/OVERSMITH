...
public class Tree : MonoBehaviour
{
    ...
    public void Spawn()
    {
        ...
        /*Instantiate(log, spawn1.position, transform.rotation);
        Instantiate(log, spawn2.position, transform.rotation);
        Instantiate(log, spawn3.position, transform.rotation);*/
    }
}
